...
const ChuckInfo: React.FC<ChuckInfoProps> = ({ whaleCount, kickCount }) => {
  ...
  return (
    <>
      <p>Number of Whales Saved: {whaleCount}</p>

      <p>Number of Round House Kicks (in the last day): {kickCount}</p>
    </>
  );
};
